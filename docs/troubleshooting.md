...
> **Note:** Can you help improve this file? [Edit this file](https://github.com/kopecn/py-cookiecut/blob/master/docs/troubleshooting.md) and submit a pull request with your improvements!
