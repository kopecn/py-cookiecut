...
def project_info(result):
    ...
    projectIdentifier = os.path.split(project_path)[-1]
    project_dir = os.path.join(project_path, projectIdentifier)
    return project_path, projectIdentifier, project_dir
